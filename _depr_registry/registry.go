...
// // New returns a new empty oldregistry.
// func New() *Registry {
// 	return &Registry{
// 		structFor:   map[string]reflect.Type{},
// 		categoryFor: map[string]core.Category{},
...
// // TODO - Change to return ISpec instead of Node.
...
// // NewComposite ...
// func (r Registry) NewComposite(name string, base core.IBase) (core.Node, error) {
// 	any, err := r.New(name)
// 	if err != nil {
// 		return nil, err
// 	}
...
// // NewDecorator ...
// func (r Registry) NewDecorator(name string, base core.IBase) (core.Node, error) {
// 	any, err := r.New(name)
// 	if err != nil {
// 		return nil, err
// 	}
...
// // NewAction ...
// func (r Registry) NewAction(name string, base core.IBase) (core.Node, error) {
// 	any, err := r.New(name)
// 	if err != nil {
// 		return nil, err
// 	}
